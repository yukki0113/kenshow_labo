...
CREATE TABLE dbo.TR_RaceResult (
    ...
    finish_pos         smallint      NULL,                -- 着順
    finish_time        TIME(2)       NULL,                -- 走破時計
    horse_weight       smallint      NULL,                -- 馬体重
    horse_weight_diff  smallint      NULL,                -- 馬体重増減
    pos_corner1        tinyint       NULL,                -- 通過順_1角
    pos_corner2        tinyint       NULL,                -- 通過順_2角
    pos_corner3        tinyint       NULL,                -- 通過順_3角
    pos_corner4        tinyint       NULL,                -- 通過順_4角
